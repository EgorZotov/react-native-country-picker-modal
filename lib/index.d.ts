...
import { TranslationLanguageCode, CountryCode, Country, Region, Subregion, CountryPickerStyles } from './types';
...
declare const Main: {
    ({ theme, translation, ...props }: CountryPickerProps): JSX.Element;
    defaultProps: {
        onSelect: () => void;
        withEmoji: boolean;
    };
